...
export interface ApiRubRateRubRate extends Struct.SingleTypeSchema {
  collectionName: 'rub_rates';
  info: {
    displayName: 'rub_rate';
    pluralName: 'rub-rates';
    singularName: 'rub-rate';
  };
  options: {
    draftAndPublish: false;
  };
